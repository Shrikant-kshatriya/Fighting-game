...
class Fighter extends Sprite{
    ...
    switchSprite(sprite){
        // overriding other animation with death
        if(this.image === this.sprites.death.image){
            if(this.framesCurrent === this.sprites.death.frameMax - 1)this.dead = true;
            return
        }

        // overriding other animation with attack
        if(this.image === this.sprites.attack1.image && this.framesCurrent < this.sprites.attack1.frameMax - 1){
            return
        }

        // ovrriding other animation with takeHit animation
        if(this.image === this.sprites.takehit.image && this.framesCurrent < this.frameMax - 1)return
